...
pub async fn load_pms(client: &ApiClient, folder: &str) -> Result<PersonalMessageListResponse, String> {
    let path = format!(
...
pub async fn mark_read(
    ...
    client.post_json("/surreal/personal_messages/read", payload).await
}
...
pub async fn delete(
    ...
    client.post_json("/surreal/personal_messages/delete", payload).await
}
...
pub async fn send(
    ...
    client.post_json("/surreal/personal_messages/send", payload).await
}
